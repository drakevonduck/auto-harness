...
* [Validators Overview](validators/README.md)
* [validate-manifest.sh](validators/validate-manifest.sh)
* [validate-module-graph.sh](validators/validate-module-graph.sh)
* [validate-required-artifacts.sh](validators/validate-required-artifacts.sh)
* [validate-placeholders.sh](validators/validate-placeholders.sh)
* [validate-agent-pack.sh](validators/validate-agent-pack.sh)
* [validate-companions.sh](validators/validate-companions.sh)
* [Shared Library: harness\_registry.rb](validators/lib/harness_registry.rb)
* [CI Integration](workflow/ci-integration.md)
* [Troubleshooting](workflow/troubleshooting.md)

## Test Suite

* [Unit Tests: HarnessRegistry](validators/test/test_harness_registry.rb)
* [Integration Tests: Validators](validators/test/test_validators_integration.rb)
...
* [HARNESS.md](examples/composed-entrypoints/HARNESS.md)
* [AGENTS.md](examples/composed-entrypoints/AGENTS.md)
* [CLAUDE.md](examples/composed-entrypoints/CLAUDE.md)
