...
**`development-harness/snippets/Universal PRD Generation Prompt.txt`** is superseded by this
overlay's workflow, `platform/templates/product/requirements.md` (enriched), `personas.md` (new),
and `platform/workflow/discovery-to-composition.md`. The snippet is retained as historical reference.
