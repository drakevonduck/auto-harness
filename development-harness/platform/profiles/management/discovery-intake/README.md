...
- `snippets/Universal PRD Generation Prompt.txt` — intent absorbed into `intake-questionnaire.md`,
  enriched `templates/product/requirements.md`, and this README
- `snippets/dev.ADR.prompt.txt` — intent absorbed into `workflow/discovery-to-composition.md` §7

Both files are retained in `snippets/` as historical reference.
