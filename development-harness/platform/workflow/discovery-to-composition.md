...
**`development-harness/snippets/Universal PRD Generation Prompt.txt`**
...
**`development-harness/snippets/dev.ADR.prompt.txt`**
Superseded by: Step 7 of this workflow (ADR seeding), `templates/adr.md` (template),
and `discovery-intake/README.md` (guidance).

Both files are retained in `development-harness/snippets/` as historical reference.
