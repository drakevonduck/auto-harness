...
| M-6 | Medium | `harness-onboarding` skill assumes brownfield = existing codebase; fails to guide assessment of documentation-only pre-development projects like adsclaw | `platform/skills/harness-onboarding/SKILL.md` | Open | Planned — add "Phase 0: Governance Inventory" to the skill for doc-only brownfield projects | — |
